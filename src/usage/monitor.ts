import type { UsageSummary } from "./ledger.js";
...
export function renderLiveUsage(summary: UsageSummary, output: NodeJS.WriteStream = process.stdout): void {
  ...
  if (output.isTTY) output.write(`\r${line}`);
